...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">@lang('messages.auth.confirm_password')</div>

                <div class="card-body">
                    @lang('messages.auth.confirm_your_password_before_continuing')
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    @lang('messages.auth.confirm_password')
                                </button>
